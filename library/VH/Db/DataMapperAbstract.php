...
abstract class VH_Db_DataMapperAbstract {
    ...
    public function save(VH_Db_DomainObjectAbstract $obj) {
    ...
    abstract protected function _insert(VH_Db_DomainObjectAbstract $obj);

    abstract protected function _update(VH_Db_DomainObjectAbstract $obj);
}